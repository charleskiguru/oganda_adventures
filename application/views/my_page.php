		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-12">
				...
				<p class="color-white">
					...
					We have the ability to design unique events and tours to fit every client. Our budget for the safaris is economic providing unique opportunity for our clients to enjoy bush, beach and Africa's spectacular scenery not forgeting the world hidden treasures.
				</p>
			</div>
...
<section id="plan" class="parallax-section">
	<div class="container">
		...
		<div class="col-md-12" style="text-align:center">
			<button id="plansButton" class="btn btn-success">View more plans -></button>
		</div>
	</div>
</section>
...
<section id="portfolio" class="parallax-section">
	<div class="container">
		<div class="row">
			...
			<?php
				foreach ($gallery as $key => $g_val) {
			?>
            <div class="col-md-4 col-sm-6">
				<div class="grid">
              		<figure class="effect-zoe">
						<img src="<?php echo base_url(); ?>assets/images/gallery/<?=$g_val['image']?>" alt="Gallery img"/>
							<figcaption>
								<h2><?=$g_val['description']?></h2>
								<p class="icon-links">
									<a href="<?php echo base_url(); ?>assets/images/gallery/<?=$g_val['image']?>" data-lightbox-gallery="portfolio-gallery" title="<?=$g_val['description']?>"><span class="icon icon-attachment"></span></a>
								</p>
							</figcaption>			
					</figure>
				</div>
			...
			<button id="portButton" class="btn btn-success">View more -></button>
	</div>
</section>
...
<script>
	$(function(){
		...
		$(document).on('click', '#portButton', function(){
			window.location.href = "<?php echo base_url(); ?>portfolio";
		});
		$(document).on('click', '#plansButton', function(){
			window.location.href = "<?php echo base_url(); ?>plans_all";
		});
	});
</script>